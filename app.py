...
# ==========================================
# 2. BAZA USŁUG (KOMPLETNA - 12 KATEGORII)
# ==========================================
...
def load_db():
    ...
    return pd.DataFrame([
        ...
        {"Kategoria": "04. Zabudowy G-K", "Nazwa": "Zabudowa stelaża WC", "Jm": "szt", "R": 480.0, "M": 190.0},
...
if mode == "🔒 Admin":
    if st.text_input("Hasło", type="password") == "mateusz.rolo31":
        ...
        if st.button("Zapisz w bazie"): new_db.to_csv(DB_FILE, index=False); st.success("Zapisano!")

# --- KALKULATOR ---
elif mode == "Kalkulator":
    # KROK 0: DANE KLIENTA (STABILNY FORMULARZ)
    if st.session_state.step == 0:
        with st.form("client_data_form"):
            ...
            submitted = st.form_submit_button("Przejdź do wyceny ➔")
            if submitted:
                if c_name:
    ...
    # KROK 2: WYNIK I ANALIZA
        ...
        with col_f2:
            st.download_button(
                ...
                data=pdf_bytes,
                file_name=f"Oferta_RenovationArt.pdf",
